...
<html>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header"><h3 class="box-title">List Fare</h3></div>
                                    <a href="addFare.php" class="btn bg-navy pull-right btnadd">ADD Fare</a>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                               <?php
												...
												?>
												<tr>
													<td><?php echo $row['fare_base_fare']; ?></td>
													<td><?php echo $row['cityName']; ?></td>
													
													
													<td>
														<a class="btn btn-primary btn-sm editbtn" href="editTicketBooking.php<?php echo '?id=' . $id; ?>">Edit</a>
														<a class="btn btn-danger btn-sm"href="javascript:del_id(<?php echo $row['fare_id']; ?>)">Delete</a>
													</td>
												</tr>
												<?php } ?>
                                            </tbody>
	...
	function del_id(id)
	{
	 ...
	 {
	  window.location='delete_fare.php?delete_id='+id
	 }
	}
	</script>
