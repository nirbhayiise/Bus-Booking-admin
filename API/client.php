...
// include the Sms class
    ...
    class MainSms
    {
        public function call()
        {
            ...
            $sms     = new Sms('A07828fe31c451c1fd2a06cb129844c31', 'EVERST', 'https://alerts.solutionsinfini.com/api/v4/');
            $dlr_url = 'https://alerts.solutionsinfini.com/api/v4/?sent={sent}&delivered={delivered}&msgid={msgid}&sid={sid}&status={status}&reference={reference}&custom1={custom1}&custom2={custom2}';

            $obj = $sms->sendSms('8285672453', 'hello', [
                //'dlr_url' => $dlr_url,
