...
<html>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header"><h3 class="box-title">List Routes</h3></div>
                                    <a href="addRoute.php" class="btn bg-navy pull-right btnadd">ADD Route</a>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                            ...
                                            <tbody>
                                               <?php
												...
												<tr>
													...
													$dataPickUp=$user->getPickUpPointAll($id,$bus_source,$bus_dest);

													while($row=mysqli_fetch_array($dataPickUp))
													{
                                                    $pickAdd=$row['bus_pickup'];
													echo  $pickAdd.',<br>';
													}
													?></td>
													...
													<td>
														...
														<a class="btn btn-danger btn-sm"href="javascript:del_id(<?php echo $routeId; ?>)">Delete</a>
													</td>
												</tr>
												<?php } ?>
                                            </tbody>
	...
	function del_id(id)
	{
	 ...
	 {
	  window.location='delete_busRoute.php?delete_id='+id
	 }
	}
	</script>
