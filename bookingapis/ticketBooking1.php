...
$qrystr="insert into ticket_booking (b_passanger_name,b_mob,b_from,b_to,b_date,b_date_of_jry,b_fare,b_dist,b_bus_id,uid,b_status) Values 
('$b_passanger_name','$b_mob','$b_from','$b_to',NOW(),'$b_date_of_jry','100','230','$b_bus_id','$b_uid','1')";
